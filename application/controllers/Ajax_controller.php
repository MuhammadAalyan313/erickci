...
class Ajax_controller extends Home_Core_Controller
{
    ...
    */
    ...
    public function ajax_search()
    {
        ...
        if($this->input->post('category', true) == 'negotiable'){
            $category = 'negotiable';
        }
        else{
            $category = clean_number($this->input->post('category', true));
    ...
    public function get_subcategories()
    {
        ...
        $html_content = '';
        if (!empty($parent_id)) {
            $subcategories = $this->category_model->get_subcategories_by_parent_id($parent_id, $lang_id);
