...
class Admin_controller extends Admin_Core_Controller
{
    ...
    */
    ...
    /**
     * Change the cover image type
     */

    public function cover_image_post()
    {
        check_permission('homepage_manager');
        $this->settings_model->cover_image_settings();
        $this->session->set_flashdata('success', trans("msg_updated"));
        $this->session->set_flashdata('cover_image_settings', 1);
        redirect($this->agent->referrer() . "#product_settings");
    }
    /*
    ...
    */
    ...
    public function contact_messages()
    {
        ...
        $this->contact_model->marksAsRead();
    ...
    */
    public function visual_settings()
    {
        ...
        $data['cover_image'] = $this->settings_model->get_cover_image_type()->cover_image_type;
        $data['admin_settings'] = $this->product_admin_model->get_admin_settings();
        $this->load->view('admin/includes/_header', $data);
