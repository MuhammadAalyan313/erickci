...
*/
$autoload['helper'] = array('url', 'security', 'custom', 'text', 'product');
...
$autoload['model'] = array('settings_model', 'language_model', 'auth_model', 'category_model', 'page_model', 'file_model',
    ...
    'earnings_admin_model', 'variation_model', 'membership_model', 'shipping_model', 'notification_model','license_model');
