...
$route['send-message-post-w']['POST'] = 'ajax_controller/mymsesage';
$route['messages-new']['POST'] = 'message_controller/get_new_conversation';
$route['send-new-message-post']['POST'] = 'message_controller/send_conversation';
$route['get-users']['POST'] = 'message_controller/get_conversation_users';
$route['conversation-message']['POST'] = 'message_controller/get_all_messages_conversation_id';
$route['conversation-message-user']['POST'] = 'message_controller/get_all_messages_user_id';
$route['get-last-message']['POST'] = 'message_controller/get_last_message_by_con_id';
$route['get-new-message']['POST'] = 'message_controller/get_new_message_by_con_id';
$route['send-messages-post-cmd']['POST'] = 'message_controller/sendingMessage';
$route['get-new-conversations']['POST'] = 'message_controller/get_new_conversations';
$route['get-last-message-users']['POST'] = 'message_controller/get_last_message_users';
$route['search-users']['POST'] = 'message_controller/userSearch';
$route['delete-conversation']['POST'] = 'message_controller/post_update_delete_conversations';
$route['mark-conversation-imp']['POST'] = 'message_controller/post_update_important_conversations';
$route['mark-conversation-imp-user']['POST'] = 'message_controller/markImp_userId';
//file
...
$route['follow-unfollow-user-ajax']['POST'] = 'profile_controller/follow_unfollow_user';
...
$route['delete-notification']['POST'] = 'notification_controller/delete_notification';
$route['get-data']['POST'] = 'home_controller/get_mapLocation';
$route['delete-license']['POST'] = 'license_controller/delete_license';
$route['check-chat-post']['POST'] = 'message_controller/check_chat_post';