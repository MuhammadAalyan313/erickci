...
foreach ($languages as $language) {
    if ($language->status == 1) {
        ...
        $route[$key . getr('location', $rts) . '/(:any)']['GET'] = 'profile_controller/location/$1';
        $route[$key . getr('map', $rts)]['GET'] = 'home_controller/map';
        $route[$key . getr('map-api', $rts)]['GET'] = 'home_controller/mapAPI';
        $route[$key . getr('reset', $rts)]['GET'] = 'home_controller/reset_location';
        ...
        /*blog*/
        $route[$key . getr('test', $rts)]['GET'] = 'home_controller/mapAPI';
        ...
        $route[$key . getr('shops-map', $rts)]['GET'] = 'home_controller/shops_map';
        $route[$key . getr('old-shop', $rts)]['GET'] = 'home_controller/oldshops';
        /*contact*/
        $route[$key . getr('contact', $rts)]['GET'] = 'home_controller/contact';
        /*messages*/
        $route[$key . getr('messages', $rts)]['GET'] = 'message_controller/messages';
        $route[$key . getr('messages', $rts) . '/'. getr('important', $rts)]['GET'] = 'message_controller/important_messages';
        $route[$key . getr('messages', $rts) . '/(:any)']['GET'] = 'message_controller/unread_messages/$1';
       
       
        $route[$key . getr('messages', $rts) . '/' . getr('conversation', $rts) . '/(:num)']['GET'] = 'message_controller/conversation/$1';
        
        $route[$key . getr('messages_view', $rts)]['GET'] = 'message_controller/view_conversation/';
        $route[$key . getr('messages_view', $rts) . '/' . getr('conversation', $rts) . '/(:num)']['GET'] = 'message_controller/view_conversation_by_con_id/$1';
        $route[$key . getr('messages_view', $rts) . '/' . getr('conversation', $rts) . '/' . getr('user', $rts) . '/(:num)']['GET'] = 'message_controller/view_conversation_by_user_id/$1';
        $route[$key . getr('messages_widget', $rts)]['GET'] = 'message_controller/messages_widget';
        $route[$key . getr('get_conversations', $rts)]['GET'] = 'message_controller/get_all_conversation_auth_id';
        $route[$key . getr('get_imp-conversations', $rts)]['GET'] = 'message_controller/get_all_important_conversation_auth_id';
        $route[$key . getr('auth-user', $rts)]['GET'] = 'message_controller/get_auth_user';
        $route[$key . getr('get-all-users', $rts)]['GET'] = 'message_controller/get_all_users';
        $route[$key . getr('unread-messages', $rts)]['GET'] = 'message_controller/get_unread_conversation';
        $route[$key . getr('deleted-messages', $rts)]['GET'] = 'message_controller/deleted_conversation';
        /*rss feeds*/
        ...
        // payment through 
        $route[$key . getr('crypto-payment', $rts)]['GET'] = 'crypto_payment_controller/status';
...
/*users routes*/
$route[getr('admin', $rts) . '/users'] = 'membership_controller/getAllUsers';
...
$route[getr('admin', $rts) . '/store-license-settings'] = 'license_controller/store_license_settings';
$route[getr('admin', $rts) . '/store-licenses'] = 'license_controller/all_store_license_keys';
$route[getr('admin', $rts) . '/add-store-license'] = 'license_controller/add_store_license_keys';
$route[getr('admin', $rts) . '/edit-store-license/(:num)'] = 'license_controller/edit_store_license_keys/$1';
// new routes starts form here

$route['chats']['GET'] = 'home_controller/chat';
$route['check-chat']['GET'] = 'message_controller/check_chat';
$route['get-notification-counts']['GET'] = 'notification_controller/get_notification_count';

// new routes ends form here
