...
class Product_admin_model extends CI_Model
{
    ...
    */
    ...
    public function newProductCount(){
        return $this->db->where('is_read', 0)->count_all_results('product_details');
    }
    public function marksAsRead(){
        $this->db->update('product_details', array('is_read' => 1), array('is_read' => 0));
    }
