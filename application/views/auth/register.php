                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            ...
                            <span class="userNameError errordisplay" id="errordisplay">Error! Username contains lowercase letter, number, hypen or undersore</span>
                        </div>
                        <div class="form-group">
                            <input type="text" name="first_name" class="form-control auth-form-input" placeholder="<?php echo trans("full_name"); ?>" value="<?php echo old("first_name"); ?>" maxlength="255" required>
                        </div>
                        <div class="form-group">
                            <input type="text" name="phone" class="form-control auth-form-input" placeholder="<?php echo trans("phone_number"); ?>" value="<?php echo old("phone_number"); ?>" maxlength="255" required>
                        </div>
                        <div class="form-group">
                        ...
                        <?php endif; ?>
                        <div class="form-group">
                            <button type="submit" id = "register" class="btn btn-md btn-custom btn-block"><?php echo trans("register"); ?></button>
                        </div>
