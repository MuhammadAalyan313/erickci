                    ...
                    <div class="row">
                        <?php if (!empty($followers)):
                            foreach ($followers as $item): ?>
                                <div class="col-4 col-lg-2 col-md-3 col-sm-2">
