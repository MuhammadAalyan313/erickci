...
<div class="row">
    ...
    <div class="col-sm-12 col-md-12 col-lg-6">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo trans('members'). " "; echo trans('contact'). " Information"; ?></h3>
            </div>
            <?php echo form_open('admin_controller/preferences_post'); ?>
            <div class="box-body">
                <div class="form-group">
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <label><?php echo trans('show')." "; echo trans('members')." "; echo trans('contact')." "; echo " Information"; ?></label>
                        </div>
                        <div class="col-md-6 col-xs-12 col-option">
                            <input type="radio" name="show_members_location" value="1" id="show_member_location" class="square-purple" <?= $this->general_settings->member_location == 1 ? 'checked' : ''; ?>>
                            <label for="show_member_location" class="option-label"><?php echo trans('yes'); ?></label>
                        </div>
                        <div class="col-md-6 col-xs-12 col-option">
                            <input type="radio" name="show_members_location" value="0" id="not_show_member_location" class="square-purple" <?= $this->general_settings->member_location != 1 ? 'checked' : ''; ?>>
                            <label for="not_show_member_location" class="option-label"><?php echo trans('no'); ?></label>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-footer">
                <button type="submit" name="submit" value="member_location" class="btn btn-primary pull-right"><?php echo trans('save_changes'); ?></button>
            </div>
            <?php echo form_close(); ?>
        </div>
    </div>
