            ...
            <section class="sidebar sidebar-scrollbar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    if (has_permission('products')) : ?>
                        ...
                        <li class="treeview<?php is_admin_nav_active(['products', 'special-offers', 'pending-products', 'hidden-products', 'expired-products', 'drafts', 'deleted-products', 'product-details', 'sold-products']); ?>">
                            <a href="#">
                                ...
                                <?php if (new_product_count() > 0) : ?>
                                    <span style="margin-right:20px; float:right; width:20px; height:20px; background-color:#FA7348;border-radius:50%; text-align:center;color:#fff"><?= new_product_count() ?></span>
                                <?php endif; ?>
                                <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                            </a>
                            <ul class="treeview-menu">
                    ...
                    if (has_permission('membership')) : ?>
                        ...
                        <li class="nav-shop-opening-requests">
                            <a href="<?php echo admin_url(); ?>shop-opening-requests">
                                ...
                                if (shop_request_count() > 0) : ?>
                                    <span style="float:right; width:20px; height:20px; background-color:#FA7348;border-radius:50%; text-align:center;color:#fff"><?= shop_request_count() ?></span>
                                <?php endif; ?>

                            </a>
                        </li>
                        <li class="treeview<?php is_admin_nav_active(['add-user', 'administrators', 'vendors', 'members', 'edit-user', 'users']); ?>">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="nav-users"><a href="<?php echo admin_url(); ?>users"> <?php echo trans("users"); ?></a></li>
                    ...
                    if (has_permission('contact_messages')) :
                        ...
                        <li class="nav-contact-messages">
                            <a href="<?php echo admin_url(); ?>contact-messages">
                                ...
                                <?php if (contact_message_count() > 0) : ?>
                                    <span style="float:right; width:20px; height:20px; background-color:#FA7348;border-radius:50%; text-align:center;color:#fff"><?= contact_message_count() ?></span>
                                <?php endif; ?>
                            </a>
                        </li>
                    <?php endif;
                        ...
                        <li class="treeview<?php is_admin_nav_active(['pending-product-comments', 'pending-blog-comments', 'product-comments', 'blog-comments']); ?>">
                            <a href="#">
                                ...
                                <?php if (comment_count() > 0) : ?>
                                    <span style="margin-right:20px; float:right; width:20px; height:20px; background-color:#FA7348;border-radius:50%; text-align:center;color:#fff"><?= comment_count() ?></span>
                                <?php endif; ?>
                                <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                            </a>
                            <ul class="treeview-menu">
                                <?php if ($this->general_settings->comment_approval_system == 1) : ?>
                                    <li class="nav-pending-product-comments"><a href="<?php echo admin_url(); ?>pending-product-comments"> <?php echo trans("product_comments"); ?>
                                            <?php if (product_comment_count() > 0) : ?>
                                                <span style="margin-right:20px; float:right; width:20px; height:20px; background-color:#FA7348;border-radius:50%; text-align:center;color:#fff"><?= product_comment_count() ?></span>
                                            <?php endif; ?>
                                        </a></li>
                                    <li class="nav-pending-blog-comments"><a href="<?php echo admin_url(); ?>pending-blog-comments"> <?php echo trans("blog_comments"); ?>
                                            <?php if (blog_comment_count() > 0) : ?>
                                                <span style="margin-right:20px; float:right; width:20px; height:20px; background-color:#FA7348;border-radius:50%; text-align:center;color:#fff"><?= blog_comment_count() ?></span>
                                            <?php endif; ?>
                                        </a></li>
                                <?php else : ?>
                                    <li class="nav-product-comments"><a href="<?php echo admin_url(); ?>product-comments"> <?php echo trans("product_comments"); ?>
                                            <?php if (product_comment_count() > 0) : ?>
                                                <span style="margin-right:20px; float:right; width:20px; height:20px; background-color:#FA7348;border-radius:50%; text-align:center;color:#fff"><?= product_comment_count() ?></span>
                                            <?php endif; ?>
                                        </a></li>
                                    <li class="nav-blog-comments"><a href="<?php echo admin_url(); ?>blog-comments"> <?php echo trans("blog_comments"); ?>
                                            <?php if (blog_comment_count() > 0) : ?>
                                                <span style="margin-right:20px; float:right; width:20px; height:20px; background-color:#FA7348;border-radius:50%; text-align:center;color:#fff"><?= blog_comment_count() ?></span>
                                            <?php endif; ?>
                                        </a></li>
                    ...
                    if (has_permission('abuse_reports')) :
                        ...
                        <li class="nav-abuse-reports">
                            <a href="<?php echo admin_url(); ?>abuse-reports">
                                ...
                                <?php if (abuse_reports_count() > 0) : ?>
                                    <span style="float:right; width:20px; height:20px; background-color:#FA7348;border-radius:50%; text-align:center;color:#fff"><?= abuse_reports_count() ?></span>
                                <?php endif; ?>
                    ...
                    if (has_permission('preferences')) : ?>
                        ...
                        <?php endif;
                        if (has_permission('general_settings')) : ?>
                            <li class="treeview<?php is_admin_nav_active(['setting','add-store-license', 'store-licenses', 'license-settings', 'store-license-settings']); ?>">
                                <a href="#">
                                    <i class="fa fa-id-card"></i>
                                    <span><?php echo "Store License Setting"; ?></span>
                                    <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                                </a>
                                <ul class="treeview-menu">
                                    <li class="nav-store-license-settings"><a href="<?php echo admin_url(); ?>store-license-settings"> <?php echo "Store License Setting"; ?></a></li>
                                    <li class="nav-store-licenses"><a href="<?php echo admin_url(); ?>store-licenses"> <?php echo "Store Licenses"; ?></a></li>
                                    <li class="nav-add-store-license"><a href="<?php echo admin_url(); ?>add-store-license"> <?php echo "Add Store License"; ?></a></li>
                                </ul>
                            </li>
                        <?php endif;
