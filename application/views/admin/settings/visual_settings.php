...
<div class="col-lg-6 col-md-12">
        <div class="box box-primary">
            <!-- /.box-header -->
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo trans("cover_image")." ".trans("settings"); ?></h3>
            </div>
            <?php echo form_open('admin_controller/cover_image_post'); ?>
            <div class="box-body">
                <!-- include message block -->
                <?php if (!empty($this->session->flashdata('cover_image_settings'))):
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12 col-option">
                            <input type="radio" name="cover_image_type" value="full_width" id="full_width" class="square-purple" <?php echo ($cover_image == "full_width") ? 'checked' : ''; ?>>
                            <label for="full_width" class="option-label"><?php echo trans("full_width"); ?></label>
                        </div>
                        <div class="col-sm-6 col-xs-12 col-option">
                            <input type="radio" name="cover_image_type" value="boxed" id="boxed" class="square-purple" <?php echo ($cover_image != "full_width") ? 'checked' : ''; ?>>
                            <label for="boxed" class="option-label"><?php echo trans("boxed"); ?></label>
                        </div>
                    </div>
                </div>
            </div>
