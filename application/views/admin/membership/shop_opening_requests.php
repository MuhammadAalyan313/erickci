                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <?php foreach ($users as $user):
                            $this->load->view('admin/includes/rejection_review',["user"=>$user]) ;
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <li>
                                                <button type="submit" name="submit" value="1" class="btn-list-button">
                                                    <i class="fa fa-check option-icon"></i><?php echo trans('non_verified'); ?>
                                                </button>
                                            </li>
                                            <li>
                                                <button type="submit" name="submit" value="2" class="btn-list-button">
                                                    <i class="fa fa-check option-icon"></i><?php echo trans('verified'); ?>
                                                </button>
                                            </li>
                                            <li>
                                                <button type="submit" name="submit" value="3" class="btn-list-button">
                                                    <i class="fa fa-check option-icon"></i><?php echo trans('licensed'); ?>
                                                </button>
                                            </li>
                                            <li>
                                                <span  data-toggle="modal" data-target="#fail_popup<?= $user->id?>"  style="width:100%;padding:8px;text-align:left" class="btn btn-list-button">
