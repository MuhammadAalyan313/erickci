...
<div class="row table-filter-container">
    <div class="col-sm-12">
        ...
        <div class="item-table-filter">
            <label><?php echo "Account Type"; ?></label>
            <select name="acc_type" class="form-control">
                <option value=""><?php echo trans("all"); ?></option>
                <option value="1" <?= input_get('acc_type') == '1' ? 'selected' : ''; ?>><?php echo "Non-verified"; ?></option>
                <option value="2" <?= input_get('acc_type') == '2' ? 'selected' : ''; ?>><?php echo "verified"; ?></option>
                <option value="3" <?= input_get('acc_type') == '3' ? 'selected' : ''; ?>><?php echo "Licensed"; ?></option>
            </select>
        </div>
        <div class="item-table-filter">
            ...
            <select name="user_role" class="form-control">
                <option value=""><?php echo trans("all"); ?></option>
                <option value="1" <?= input_get('user_role') == '1' ? 'selected' : ''; ?>><?php echo "Administrator"; ?></option>
                <option value="2" <?= input_get('user_role') == '2' ? 'selected' : ''; ?>><?php echo "Vendor"; ?></option>
                <option value="3" <?= input_get('user_role') == '3' ? 'selected' : ''; ?>><?php echo "Member"; ?></option>
            </select>
        </div>
        <div class="item-table-filter">
