    ...
    <div class="col-sm-8">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <?php if (!empty($role)):
                    $role_name = @parse_serialized_name_array($role->role_name, $this->control_panel_lang->id, true);
                    if (!empty($role_name)):?>
                ...
                <?php
                $license_number = '';
                if($this->session->flashdata('license_data') !== null){
                    
                  $license_number= $user->license_number == null ? $this->session->flashdata('license_data') : $user->license_number;
                }
                $license_type = $this->session->flashdata('license_type') != null ?$this->session->flashdata('license_type'):null;
    
                ?>

                <div class="form-group">
                    <label><?php echo "License ". trans('type'); ?></label>
                   <select class="form-control form-select" name="license_type" id="">
                    <?php
                        echo ($user->license_type == Null) ? '<option value="" hidden>Select License Type</option>':'<option value="'.$user->license_type.'">'.$user->license_name.'</option>'; 
                    ?>
                    <?php
                    foreach($licenses as $license):
                        ?>
                        <option <?php echo $license_type == $license->id? "Selected": ''?> value="<?php echo $license->id; ?>"><?php echo $license->name; ?></option>
                        <?php
                    endforeach;
                    ?>
                   </select>
                ...
                <div class="form-group">
                    <label><?php echo "License ". trans('number'); ?></label>
                    <input type="text" class="form-control form-input"
                           name="license_number" placeholder="<?php echo "License ". trans('number'); ?>"
                           
                           <?php echo ($user->license_number == Null ) ?  'value="'.html_escape($license_number).'"': 'value="'.html_escape($user->license_number).'"'; ?> <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <?php $this->load->view("partials/_location", ['countries' => $this->countries, 'country_id' => $user->country_id, 'state_id' => $user->state_id, 'city_id' => $user->city_id, 'map' => false, 'is_location_optional' => true]); ?>
                    <div class="row">
                ...
                <div class="form-group">
                    <label class="control-label"><?php echo trans('personal_website_url'); ?></label>
                    <input type="text" class="form-control form-input" name="personal_website_url"
                           placeholder="<?php echo trans('personal_website_url'); ?>" value="<?php echo html_escape($user->personal_website_url); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-input" name="whatsapp_url"
                           placeholder="<?php echo trans('whatsapp_url'); ?>" value="<?php echo html_escape($user->whatsapp_url); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-input" name="telegram_url"
                           placeholder="<?php echo trans('telegram_url'); ?>" value="<?php echo html_escape($user->telegram_url); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                </div>
                <div class="form-group">
