...
<?php 
 if($this->auth_user->role_id == 3){
    echo character_limiter($this->auth_user->first_name, 15, '..'); 
 }
 else{
    echo character_limiter(get_shop_name($this->auth_user), 15, '..'); 
 }
?>

<i class="icon-arrow-down"></i>
<span id='me-load-5'>
    <span  id='message-count-5'>
