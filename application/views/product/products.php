            ...
            <div class="col-12 product-list-header">
                ...
                <div class="product-sort-by">
                    ...
                    <span class="optionTag"></span>
                        ...
                        <option class="option" value="most_recent"<?= $filter_sort == 'most_recent' ? ' selected' : ''; ?>><?= trans("most_recent"); ?></option>
                            <option class="option" value="lowest_price"<?= $filter_sort == 'lowest_price' ? ' selected' : ''; ?>><?= trans("lowest_price"); ?></option>
                            <option class="option" value="highest_price"<?= $filter_sort == 'highest_price' ? ' selected' : ''; ?>><?= trans("highest_price"); ?></option>
                            <?php
                                if($breadcrumb == null || $breadcrumb != 'Negotiable'):
                                    if($breadcrumb != 'Products'):
                            ?>
                                    <option value="negotiable"<?= $filter_sort == 'negotiable' ? ' selected' : ''; ?>><?= trans("is_negotiable"); ?></option>
                            <?php
                            endif;
                                endif;
                            ?>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-3 col-sidebar-products">
                <div id="collapseFilters" class="product-filters">
                    <?php if (!empty($category) || !empty($categories) || $breadcrumb != null ): ?>
                        <div class="filter-item">
                        <?php 
                            if($breadcrumb == 'Negotiable'){?>
                            <a href="<?= site_url() . 'products'?>" class="filter-list-categories-parent">
                                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-left-short" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M12 8a.5.5 0 0 1-.5.5H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5a.5.5 0 0 1 .5.5z"/>
                                    </svg>
                                <span ><?= trans("is_negotiable"); ?></span>
                                <?php
                            }
                            else{
                            ?>
                            <?php 
                             if($breadcrumb == 'Products'){
                                ?>
                                    <h4 class="title"><a href="<?= site_url().'negotiable'?>"><?= trans("is_negotiable"); ?></a></h4>
                                <?php
                             }
                             ?>
