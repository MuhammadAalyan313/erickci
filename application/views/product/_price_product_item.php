...
<span class="price"><?php echo price_formatted(calculate_product_price($product->price, $product->discount_rate), $product->currency, false); ?></span><?= $negotiableTag?>
<?php else:
...
<?php endif; ?>
<span class="price"><?php echo price_formatted(calculate_product_price($product->price, $product->discount_rate), $product->currency, true); ?></span><?= $negotiableTag?>
<?php endif;
endif;
endif; ?>