            ...
            <div class="row">
                <div class="col-12">
                    <nav class="nav-breadcrumb" aria-label="breadcrumb">
                        <ol style="list-style: none;display:flex;justify-content:space-between;margin-bottom:1rem" class="breadcrumb ">
                        <?php if($previousurl == 'end'){?>
                            <li class=""><a href="#" style="pointer-events: none;" >Previous</a></li>

                        <?php  
                        }else{ ?>
                      <li class=""><a href="<?= $previousurl?>" style="color:#FA7348">Previous</a></li>
                        <?php }?>
                        
                        <?php if($nexturl == 'end'){?>
                            <li class=""><a href="#" style="pointer-events: none;">Newer</a></li>

                        <?php  
                        }else{ ?>
                        <li class=""><a href="<?= $nexturl?>" style="color:#FA7348">Newer</a></li>
                        <?php }?>
                        </ol>
                        ...
                        <a href="javascript:history.back()"><i class="left-angle"></i> back to result</a>
                        </span>
                    </nav>
                </div>
