                                    ...
                                    <div class="row-custom">
                                        <p class="username">
                                            ...
                                            if (!empty($comment->user_id)):
                                                if($comment->user_role == 2 || $comment->user_role == 1){
                                                    echo !empty($comment->user_shop_name) ? html_escape($comment->user_shop_name) : html_escape($comment->name);
                                                }
                                                else{
                                                    echo !empty($comment->user_first_name) ? html_escape($comment->user_first_name)." ".html_escape($comment->user_last_name) : html_escape($comment->name);
                                                }
