                            ...
                            <div class="right">
                                <div class="row-custom">
                                    <p class="username">
                                        ...
                                        if (!empty($subcomment->user_id)):
                                            if($subcomment->user_role == 2 || $subcomment->user_role == 1){
                                                echo !empty($subcomment->user_shop_name) ? html_escape($subcomment->user_shop_name) : html_escape($subcomment->name);
                                            }
                                            else{
                                                echo !empty($subcomment->user_first_name) ? html_escape($subcomment->user_first_name)." ".html_escape($subcomment->user_last_name) : html_escape($subcomment->name);
                                            }
                                        else:
                                ...
                                <div class="row-custom">
                                    ...
                                    <?php if ($this->auth_check):
                                        if ($subcomment->user_id == $this->auth_user->id || has_permission('comments')): ?>
                                    ...
                                    <?php if ($this->auth_check):
                                        if ($subcomment->user_id != $this->auth_user->id):?>
