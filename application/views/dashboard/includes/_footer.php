...
<script src="<?php echo base_url(); ?>assets/admin/js/dashboard-2.2.js"></script>
...
$(function() {
  ...
  if('<?= input_get('startdate')?>'){
    $('input[id="daterange"]').val('<?= input_get('startdate')?> - <?= input_get('enddate')?>')
  }
});
</script>
</body>
