...
<div class="row">
    <div class="col-sm-7">
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <?php endif; ?>
                <?php if($this->auth_user->license_number == null): ?>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-4 m-b-15">
                            <select id="select_countries" name="license_type" class="select2 form-control h-100" required>
                                <?php
                                echo ($this->auth_user->license_type == Null) ? '<option value="" hidden>Select License Type</option>' : '<option value="'.$this->auth_user->license_name .'">' . $this->auth_user->license_name . '</option>';
                                ?>
                        ...
                        <div class="col-12 col-sm-4 m-b-15">
                            <input type="text" <?php echo ($this->auth_user->license_number == Null) ? '' : 'value="' . html_escape($this->auth_user->license_number) . '"'; ?> name="license_number" class="form-control form-input" placeholder="<?php echo "License Number"; ?>" required>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
    ...
    <?php if ($this->payment_settings->cash_on_delivery_enabled == 1) : ?>
        <div class="col-sm-5">
            <div class="box">
                <div class="box-header with-border">
                    <div class="left">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-custom-option">
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="cash_on_delivery" value="1" id="cash_on_delivery_1" class="custom-control-input" <?= ($this->auth_user->cash_on_delivery == 1) ? 'checked' : ''; ?>>
                                    <label for="cash_on_delivery_1" class="custom-control-label"><?php echo trans("enable"); ?></label>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-custom-option">
                                <div class="custom-control custom-radio">
                                    <input type="radio" name="cash_on_delivery" value="0" id="cash_on_delivery_2" class="custom-control-input" <?= ($this->auth_user->cash_on_delivery != 1) ? 'checked' : ''; ?>>
                                    <label for="cash_on_delivery_2" class="custom-control-label"><?php echo trans("disable"); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group text-right">
                        <button type="submit" name="submit" value="cash_on_delivery" class="btn btn-md btn-success"><?php echo trans("save_changes") ?></button>
                    </div>
                    <?php echo form_close(); ?>
                </div>
            </div>
