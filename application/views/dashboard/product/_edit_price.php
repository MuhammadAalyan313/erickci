            ...
            <div id="price_input_container" class="form-group">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 m-b-sm-15">
                                <div class="custom-control custom-checkbox is_negotiable-box">
                                    <div class="col-12">
                                        <input type="checkbox" class="col-12 custom-control-input" name="is_negotiable" id="is_negotiable" value="1" <?php echo ($product->is_negotiable == 1) ? 'checked' : ''; ?>>
                                        <label for="is_negotiable" class="custom-control-label"><?php echo trans("is_negotiable"); ?></label>
                                    </div>
                                    
                                    <!-- <div class="col-12" style="margin:5px 0">
                                        <input type="radio" class="col-12 custom-control-input" name="is_negotiable" id="non_negotiable" value="0" <?php echo ($product->is_negotiable == 0) ? 'checked' : ''; ?>>
                                        <label for="non_negotiable" class="custom-control-label"><?php echo trans("non_negotiable"); ?></label>
                                    </div> -->
                                    
                                </div>
                            </div>
                                <!-- <input type="checkbox" name="is_negotiable" class="form-control custom-control-input" > -->
                            </div>
                    <div class="col-xs-12 col-sm-4 m-b-sm-15">
                        ...
                        <p class="calculated-price">
                            ...
                            <b id="earned_amount" class="earned-price">
                                ...
                                if (!empty($product)) {
                                    ...
                                    $earned_amount = $price - (($price * $this->general_settings->commission_rate) / 100);
                                }
                                $earned_amount = number_format($earned_amount, 2, '.', '');
                                echo get_price($earned_amount, 'input'); ?>
                            </b>
        ...
        <div class="form-box">
            <div class="form-box-head">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 m-b-sm-15">
                        <h4 class="title"><?php echo trans("is_negotiable"); ?></h4>
                    </div>
                </div>
            </div>
            <div class="form-box-body">
                        ...
                        <?php if ($this->payment_settings->allow_all_currencies_for_classied == 1): ?>
                            ...
                            <div class="col-xs-12 col-sm-6 m-b-sm-15">
                                <div class="custom-control custom-checkbox is_negotiable-box">
                                    <div class="col-12">
                                        <input type="checkbox" class="col-12 custom-control-input" name="is_negotiable" id="is_negotiable" value="1" <?php echo ($product->is_negotiable == 1) ? 'checked' : ''; ?>>
                                        <label for="is_negotiable" class="custom-control-label"><?php echo trans("yes"); ?></label>
                                    </div>
    ...
    <script>
        ...
        function calculate_earn_amount() {
            ...
            if (!Number.isNaN(price)) {
                ...
                earned_amount = calculated_amount - ((calculated_amount * commission_rate) / 100);
                earned_amount = earned_amount + vat_amount;
