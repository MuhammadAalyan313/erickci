                    ...
                    <div id="category_select_container">
                        <?php if (!empty($category)):
                            ...
                            foreach ($parent_array as $parent_id):
                                ...
                                if (!empty($parent_item)):
                                    ...
                                    if (!empty($subcategories)): ?>
                                        <select name="category_id[]" class="form-control subcategory-select custom-select<?= $level == 1 ? ' category-select-first' : ''; ?>" data-level="<?= $level; ?>" onchange="get_subcategories(this.value, 1, <?= $this->selected_lang->id; ?>);" <?= $level == 1 ? 'required' : ''; ?>>
                            ...
                            if (!empty($category)):
                                ...
                                if (!empty($subcategories)): ?>
                                    <select name="category_id[]" class="form-control subcategory-select custom-select" data-level="<?= $level; ?>" onchange="get_subcategories(this.value, 1, <?= $this->selected_lang->id; ?>);">
                                        <option value=""><?php echo trans('select_category'); ?></option>
                                        <?php foreach ($subcategories as $subcategory): ?>
                            ...
                            <select id="categories" name="category_id[]" class="form-control custom-select m-0" onchange="get_subcategories(this.value, 1, <?= $this->selected_lang->id; ?>);" required>
                                <option value=""><?php echo trans('select_category'); ?></option>
                        ...
                        <div id="collapse_<?= $language->id; ?>" class="panel-collapse collapse <?= $this->selected_lang->id == $language->id ? 'in' : ''; ?>">
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title_<?= $language->id; ?>" value="<?= !empty($product_details) ? html_escape($product_details->title) : ''; ?>" class="form-control form-input" placeholder="<?php echo trans("title"); ?>" <?= $this->selected_lang->id == $language->id ? 'required' : ''; ?> maxlength="490">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="seo_title_<?= $language->id; ?>" value="<?= !empty($product_details) ? html_escape($product_details->seo_title) : ''; ?>" class="form-control form-input m-b-5" placeholder="<?php echo trans("title"); ?>" maxlength="490">
                                    <input type="text" name="seo_description_<?= $language->id; ?>" value="<?= !empty($product_details) ? html_escape($product_details->seo_description) : ''; ?>" class="form-control form-input m-b-5" placeholder="<?php echo trans("description"); ?>" maxlength="490">
                                    <input type="text" name="seo_keywords_<?= $language->id; ?>" value="<?= !empty($product_details) ? html_escape($product_details->seo_keywords) : ''; ?>" class="form-control form-input m-b-5" placeholder="<?php echo trans("keywords"); ?> (E.g. book, new, pencil)" maxlength="490">
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
...
<script>
    function get_subcategories(parent_id, level, lang_id) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (obj.result == 1 && obj.html_content != '') {
                    var select_tag = '<select class="form-control subcategory-select custom-select" data-level="' + new_level + '" name="category_id[]" onchange="get_subcategories(this.value,' + new_level + ',' + lang_id + ');">' +
                        '<option value=""><?= trans('select_category'); ?></option>' + obj.html_content + '</select>';
