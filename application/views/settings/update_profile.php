                ...
                <div class="row-custom">
                    <div class="profile-tab-content">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="username" class="form-control form-input" value="<?php echo html_escape($user->username); ?>" placeholder="<?php echo trans("username"); ?>" maxlength="<?php echo $this->username_maxlength; ?>" required readonly>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="first_name" class="form-control form-input" value="<?php echo html_escape($this->auth_user->first_name); ?>" placeholder="<?php echo trans("full_name"); ?>" maxlength="250" required>
                        </div>
                        ...
                        <div class="form-group m-b-30">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" name="online_status" value="1" id="onlin_status_show" class="custom-control-input" <?php echo ($this->auth_user->online_status == 1) ? 'checked' : ''; ?>>
                                <label for="onlin_status_show" class="custom-control-label"><?php echo "Show Online Status"; ?></label>
                            </div>
                        </div>
